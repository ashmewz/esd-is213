...
export default function LoginPage() {
  ...
  if (isCustomer) return <Navigate to={returnTo || "/"} replace />;
    ...
    <div className="min-h-[calc(100vh-140px)] bg-[#f7f7f8] px-4 py-8">
      <div className="mx-auto max-w-lg">
        <div className="mx-auto max-w-[520px] rounded-[24px] bg-white px-7 py-8 shadow-sm md:px-8">
          ...
          {registeredSuccess && (
            <div className="mx-auto mt-4 max-w-[380px] rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700">
